...
import { PostDropDown,Comments } from "./";
      ...
      <div className="post-wrapper post-background">
        <div className="post-header">
          ...
          <Link to={`/user/${creator}`}>
            ...
            {auth.isLoggedIn && auth.user._id == creator && (
              <PostDropDown postId={_id} setEditId={setEditId} />
            )}
          </div>
          ...
          <div className="post-actions">
            ...
            >
              <span style={{marginRight:"3px",fontWeight:"900px"}}>Comment</span>
              <img
